...
**GAStech-email_edges.csv** which consists of two weeks of 9063 emails correspondences between 55 employees. ![](images/image1.jpg)

### 9.3.2 The Nodes Data

**GAStech_email_nodes.csv** which consist of the names, department and title of the 55 employees. ![](images/image2.jpg)
...
## 9.4 Creating Network Object using tidygraph
...
-   *activate()* verb from **tidygraph** serves as a switch between tibbles for nodes and edges. All dplyr verbs applied to **tbl_graph** object are applied to the active tibble. ![](images/image3.jpg)

### 9.4.3 Using `tbl_graph()` to build tidygraph data model.

In this section, you will use `tbl_graph()` of **tinygraph** package to build an tidygraph's network graph data.frame. Before typing the codes, you are recommended to review to reference guide of [`tbl_graph()`](https://tidygraph.data-imaginist.com/reference/tbl_graph.html)
...
### 9.4.4 Reviewing the Output of tidygraph's Object

```{r}
GAStech_graph
```

### 9.4.5 Reviewing the Output of tidygraph's Object
