...
Before we dive into the steps for creating animated statistical graph, it's important to understand some of the key concepts and terminology related to this type of visualisation.
...
globalpop <- read_xls("chap04/data/GlobalPopulation.xls",
                      sheet="Data") %>%
...
[**gganimate**](https://gganimate.com/) extends the grammar of graphics as imlemented by ggplot2 to include the description of animation. It does this by providing a range of new grammar classes that can be added to the plot object in order to customise how it should change with time.
