...
![](images/image1.jpg){width="40" style="float: left; margin-right: 10px; vertical-align: middle;"} is an R package for **declaratively** creating **data-driven** graphics based on ***The Grammar of Graphics***

![](images/image2.png) It is also part of the tidyverse family specially designed for visual exploration and communication.

![](images/image3.png)

-   For more detail, visit [ggplot2](https://ggplot2.tidyverse.org/) link.
...
![](images/image4.jpg)Reference: Hadley Wickham (2010) [“A layered grammar of graphics.”](https://vita.had.co.nz/papers/layered-grammar.html) *Journal of Computational and Graphical Statistics*, vol. 19, no. 1, pp. 3–28.
...
-   *geom_map* for drawing polygons in the shape of a map! (You can access the data to use for these maps by using the map_data() function). ![](images/image5.png) ![](images/image5.jpg)
...
In the code chunk below, - *bins* argument is used to change the number of bins to 20, - *fill* argument is used to shade the histogram with light blue color, and - *color* argument is used to change the outline colour of the bars in black
...
### 1.8.2 Working with the stat - the *stat_summary()* method

The code chunk below adds mean values by using [stat_summary()]{.underline} function and overriding the default geom.
