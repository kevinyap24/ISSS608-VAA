...
By the end of this hands-on exercise, you will be able to: - create bullet chart by using ggplot2, - create sparklines by using ggplot2 , - build industry standard dashboard by using R Shiny.
...
### 10.3.2 Importing Databse into R
...
### 10.3.5 Plotting sparklines using ggplot2
