...
-   It is designed for both frequentist and Bayesian uncertainty visualization, taking the view that uncertainty visualization can be unified through the perspective of distribution visualization:
    ...
    -   for Bayesian models, one visualises probability distributions (see the tidybayes package, which builds on top of ggdist). ![](images/ggdist.png)
...
exam %>%
  ...
  stat_pointinterval(
    ...
    .interval = qi) +   
  labs(
    title = "Visualising confidence intervals of mean math score (95% and 99% CI)",
    subtitle = "Mean Point + Multiple-interval plot")
```
